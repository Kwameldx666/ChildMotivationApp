        ...
        try
        {
            ...
            try
            {
                var seedSql = """
                    ...
                    SELECT * FROM (VALUES
                        ('a3000000-0000-0000-0000-000000000001'::uuid, 'a1000000-0000-0000-0000-000000000002',
                        ...
                        ('a3000000-0000-0000-0000-000000000002'::uuid, 'a1000000-0000-0000-0000-000000000002',
                        ...
                        ('a3000000-0000-0000-0000-000000000003'::uuid, 'a1000000-0000-0000-0000-000000000002',
                         'reward_available', 'Новая награда!', 'У тебя достаточно баллов для «Настольная игра с родителем»! 🎲',
                         false, NOW()-INTERVAL '2 hours', NULL),
                        ('a3000000-0000-0000-0000-000000000004'::uuid, 'a1000000-0000-0000-0000-000000000003',
                        ...
                        ('a3000000-0000-0000-0000-000000000005'::uuid, 'a1000000-0000-0000-0000-000000000003',
                        ...
                        ('a3000000-0000-0000-0000-000000000006'::uuid, 'a1000000-0000-0000-0000-000000000001',
                        ...
                        ('a3000000-0000-0000-0000-000000000007'::uuid, 'a1000000-0000-0000-0000-000000000001',
                        ...
                        ('a3000000-0000-0000-0000-000000000008'::uuid, 'a1000000-0000-0000-0000-000000000001',
