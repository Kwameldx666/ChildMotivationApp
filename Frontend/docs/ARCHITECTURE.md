<!-- cspell:disable -->
# FamilyTask - Архитектура системы
...
FamilyTask - это полнофункциональное приложение для управления семейными задачами и наградами с встроенным ИИ-помощником и геймификацией.
