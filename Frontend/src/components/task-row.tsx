...
const STATUS_THEME = {
  ...
  in_progress: {
    ...
    progress: "from-indigo-600 to-violet-700 dark:from-indigo-500 dark:to-violet-600",
  ...
  pending: {
    ...
    progress: "from-fuchsia-600 to-violet-700 dark:from-fuchsia-500 dark:to-violet-600",
